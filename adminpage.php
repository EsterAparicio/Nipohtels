...
<html lang="en">
  <head>
    ...
    <title>Admin tools - Nipohtels</title>
            ...
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="probootstrap-slider-text text-center">
                  ...
                  <h1 class="probootstrap-heading probootstrap-animate">Admin tools</h1>
                  <div class="probootstrap-animate probootstrap-sub-wrap">There's a sunrise and sunset every single day, and they're absolutely free. Don't miss so many of them.</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="table-responsive">
    ...
    <tr>
      <td><a href="admintools/newadmin.php">Create a new administrator user</a></td> <!--FUNCIONA-->
      <td><a href="admintools/newhotel.php">Register a new hotel</a></td><!--FUNCIONA-->
      <td><a href="admintools/showreservations.php">Show all reservations</a></td><!--FUNCIONA-->
    </tr>
    <tr>
      <td><a href="admintools/newuser.php">Create a new client user</a></td><!--FUNCIONA-->
      <td><a href="admintools/newroom.php">Register a new room</a></td><!--FUNCIONA-->
      <td><a href="admintools/dropreservation.php">Cancel a reservation</a></td><!--FUNCIONA (Cambiar el h1)-->
    </tr>
    <tr>
      <td><a href="admintools/dropuser.php">Delete user</a></td><!--FUNCIONA-->
      <td><a href="admintools/newpension.php">Register hotel pensions</a></td><!--FUNCIONA-->
      <td><!--<a href="admintools/newreservation.php">Create new reservation</a>--></td><!-- NO FUNCIONA-->
    </tr>
    <tr>
      <td></td>
      <td><a href="admintools/drophotel.php">Delete a hotel</a></td><!--FUNCIONA-->
      <td></td>
    </tr>
    <tr>
      <td></td>
      <td><a href="admintools/droproom.php">Delete a room</a></td><!--FUNCIONA-->
      <td></td>
    </tr>
    <tr>
      <td></td>
      <td><a href="admintools/dropallrooms.php">Delete all rooms from an hotel</a></td><!--FUNCIONA-->
      <td></td>
    </tr>
      </table>
    </div>
