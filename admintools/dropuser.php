...
<html lang="en">
  <head>
    ...
    <title>Delete user - Nipohtels</title>
            ...
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="probootstrap-slider-text text-center">
                  ...
                  <h1 class="probootstrap-heading probootstrap-animate">Delete user</h1>
                  <div class="probootstrap-animate probootstrap-sub-wrap">I don't know where I'm going, but I'm on my way.</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="col-md-12 text-center" style="width: 200px; height: 100%; position: relative; left: 850px; margin-top: 50px; margin-bottom: 50px;">
    <!--<div class="col-md-6 col-md-offset-3 text-center" id="newadmin">-->
        ...
        <button type="submit" class="btn btn-default" value="Delete user" name="dropuser">Delete user</button>
      </form>
      <?php 
      ...
      $correo = $_POST['correo'];
      if (empty($correo)) {
            array_push($errors, "You haven't identified the user");
        }
