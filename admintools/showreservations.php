<?php
    ...
    $query = "SELECT * FROM reservas INNER JOIN habitaciones_reservas ON habitaciones_reservas.reservas_id_reserva = id_reserva
        INNER JOIN habitaciones ON habitaciones_reservas.habitaciones_id_habitacion = habitaciones.id_habitacion
        INNER JOIN hoteles ON hoteles.id_hotel = habitaciones.hoteles_id_hotel WHERE fecha_reserva_inicio >= '$fecha' GROUP BY id_reserva";
...
<html lang="en">
  <head>
    ...
    <title>Show all reservations - Admintools</title>
            ...
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="probootstrap-slider-text text-center">
                  ...
                  <h1 class="probootstrap-heading probootstrap-animate">Show reservations</h1>
                  <div class="probootstrap-animate probootstrap-sub-wrap">Because when you stop and look around, this life is pretty amazing.</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <table class="user-table-reservations">
   ...
   if(mysqli_num_rows($raw_results) > 0){
    echo "<tr><th>Hotel</th><th>User</th><th>Start date</th><th>End date</th><th>Final price</th></tr>";
    while($results = mysqli_fetch_array($raw_results)){ 
                echo "<tr>";
                echo "<td> ".$results['nombre']."</td>";
                echo "<td> ".$results['usuarios_correo_usuario']."</td>";          
