...
<html lang="en">
  <head>
    ...
    <title>Create new user - Nipohtels</title>
            ...
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="probootstrap-slider-text text-center">
                  ...
                  <h1 class="probootstrap-heading probootstrap-animate">Create new client</h1>
                  <div class="probootstrap-animate probootstrap-sub-wrap">It doesn't matter where you're going, it's who you have beside you.</div>
                </div>
              </div>
            </div>
          </div>
