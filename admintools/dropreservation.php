...
<html lang="en">
  <head>
    ...
    <title>Cancel reservation - Admintools</title>
            ...
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="probootstrap-slider-text text-center">
                  ...
                  <div class="probootstrap-animate probootstrap-sub-wrap">Doing what you like is freedom, liking what you do is happiness.</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="col-md-12 text-center" style="width: 200px; height: 100%; position: relative; left: 850px; margin-top: 50px; margin-bottom: 50px;">
    <div class="search-div">
      <form action="dropreservation.php" method="POST">
        ...
        Start date: <input type="date" name="fechaentrada"/><br>
      ...
      if (empty($correo)) {
            array_push($errors, "El correo del usuario es necesario");
        }
