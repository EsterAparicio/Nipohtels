...
<html lang="en">
  <head>
    ...
    <title>My account - Nipohtels</title>
            ...
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="probootstrap-slider-text text-center">
                  ...
                  <h1 class="probootstrap-heading probootstrap-animate">My account</h1>
                  <div class="probootstrap-animate probootstrap-sub-wrap">Like all great travellers, I have seen more than I remember and remember more than I have seen.</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="table-responsive">
    <table class="user-table">
        <tr>
          <td><a href="userreservations.php"><img class="user-menu" src="img/seereservations.png"><br>See my reservations</a></td><!--READY-->
          <td><a href="ratereservation.php"><img class="user-menu" src="img/evaluation.png"><br>Rate a reservation</a></td><!--READY-->
        </tr>
        <tr>
          <td><a href="cancelreservation.php"><img class="user-menu" src="img/cancelreservation.png"><br>Cancel reservation</a></td><!--READY (remember to config the new h1)-->
          <td><a href="changepass.php"><img class="user-menu" src="img/keyhole.png"><br>Change password</a></td><!--READY (Colocar bien el formulario)-->
        </tr>
      </table>
  </section>
